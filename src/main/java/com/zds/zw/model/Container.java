...
public class Container extends MetaContent implements ContentNode {
    ...
    private boolean _ready_to_publish;

    @JsonCreator
    public Container(@JsonProperty("object") String object,
        ...
        this._ready_to_publish = ready_to_publish;
    }
    ...
    public boolean getReady_to_publish() {
        return _ready_to_publish;
    }
